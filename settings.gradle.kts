...
include(":platform:i18n:api")
include(":platform:i18n:implementation")
include(":platform:navigation:navigator:api")
include(":platform:navigation:navigator:kernel:implementation")
include(":platform:navigation:navigator:screen:api")
include(":platform:navigation:plugin:api")
include(":platform:network:rest:api")
include(":platform:network:rest:implementation")
...
include(":screens:location-weather:screen:implementation")
